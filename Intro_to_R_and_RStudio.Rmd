...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/rebaviles21/QBIO_490_rebecca")) 
```
...
string_Name <- "Name" 
string_Age <- "Age"
string_Birthday <- "MM/DD/YY"
three_fav_colors <- "Three Favorite Colors"
```
...
```
    colnames(mtcars$hp)
    rownames(mtcars$hp)
    mtcars["Duster 360, Lincoln Continental, Maserati Bora", "hp"]
...
```{r Exercise 9.4}
# write code here
``` df_copy <- df[rownames(mtcars),colnames(-9)]
